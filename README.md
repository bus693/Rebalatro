...
* Base discards increased by 1
* Base hands decreased by 1
* All standard packs now contain 1 more card
* Mult card gives +5 Mult instead of +4 Mult
* Bonus card gives +35 Chips instead of +30 Chips
...
* Blue stake - Starting at Ante 5: Big Blind is replaced with a Boss Blind, Small Blind is replaced with a Big Blind. Ante 8 has a Big Blind, Boss Blind, and a Showdown blind.
...
* Onyx Agate - +8 mult, was +7
* Smiley Face - +6 Mult, was +5
* Scary Face - +35 Chips, was +30
* Even Steven - +6 Mult, was +5
* Odd Todd - +35 Chips, was +31
...
* Ox can now appear at Ante 3
* Cerulean Bell - now also removes a card from the played hand before scoring (does not affect poker hand determination)
...
* Venus - Now gives +3 Mult and +10 Chips
...
* Familiar, Incantation, and Grim - now destroy 1 selected card instead of 1 random in hand.
* Hex - now destroys a random other joker, instead of all other jokers.



**Decks:**

* Ghost Deck - still has base effect, but now spectrals can now appear in Arcana Packs (vanilla omen globe effect)
...
* Magic Trick - adds a playing card slot to the shop (can have edition, seal, or enhancement)
...
* Omen Globe - Now +1 consumable slot, original effect moved to Ghost Deck
...
* Only the follow vouchers can appear in Ante 1: Voucher, Coupon, Uncommon, Rare, Polychrome, Foil, Holographic, Investment, Economy
* Juggle Tag - now lasts for the rest of the Ante instead of until the end of the next round
